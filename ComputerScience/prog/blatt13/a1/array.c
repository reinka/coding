...
void set_element(array_t array, unsigned long long element_number,
                 void *new_value) {
    memcpy( ((char*)(array.data)) + (element_number * array.element_size), new_value, array.element_size);
}

// returns a pointer to element number <element_number>
void *get_element(array_t array, unsigned long long element_number) {
    
    void *ptr = (char*)array.data + element_number * array.element_size
    //void *ptr = &((array->data)[element_number]);
    return ptr;
}
